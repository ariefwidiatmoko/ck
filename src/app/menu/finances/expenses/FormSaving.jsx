...
const validate = combineValidators({
  savingPrimary: isNumeric({ message: 'Masukkan angka' }),
  savingSecondary: isNumeric({ message: 'Masukkan angka' }),
  savingTertier: isNumeric({ message: 'Masukkan angka' }),
});
