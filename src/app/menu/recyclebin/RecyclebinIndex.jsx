...
import { recyclebinsFetch } from "./redux/recyclebinsApi";
import LoadingButton from "../../main/LoadingButton";
import RecyclebinList from "./RecyclebinList/RecyclebinList";
...
class RecyclebinIndex extends Component {
  componentDidMount = () => {
...
export default compose(withRouter, connect(mapState, actions))(RecyclebinIndex);
