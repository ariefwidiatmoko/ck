...
export default class ProfileTab extends Component {
  render() {
    ...
    return (
      <div className="tabs">
        <ul>
          <li className={pathname === `/pengaturan-user/profil/info` ? "is-active" : ""}>
          ...
          <li className={pathname === `/pengaturan-user/profil/tentang` ? "is-active" : ""}>
          ...
          <li className={pathname === `/pengaturan-user/profil/foto` ? "is-active" : ""}>
          ...
          <li className={pathname === `/pengaturan-user/profil/akun` ? "is-active" : ""}>
