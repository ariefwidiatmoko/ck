...
import UserFormEditTab from "./UserFormEditTab";
import UserFormViewBasic from "./UserFormViewBasic";
import UserFormViewAccount from "./UserFormViewAccount";
import UserFormViewRole from "./UserFormViewRole";
                  ...
                  <div className="column">
                    <div className="box">
                      ...
                      {this.state.activeTab === "basic" && (
                        <UserFormViewBasic user={user} />
                      )}
                      {this.state.activeTab === "account" && (
                        <UserFormViewAccount user={user} roles={roles} />
                      )}
                      {this.state.activeTab === "role" && (
                        <UserFormViewRole user={user} roles={roles} />
                      )}
                    </div>
                  </div>
                </div>
...
export default withRouter(connect(mapState, actions)(UserFormView));
