...
import UserFormEditBasic from "./UserFormEditBasic";
import UserFormEditAccount from "./UserFormEditAccount";
import UserFormEditRole from "./UserFormEditRole";
...
export default withRouter(connect(mapState, actions)(UserFormEdit));
