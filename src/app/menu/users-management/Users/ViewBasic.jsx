...
class ViewBasic extends Component {
  render() {
    const { user } = this.props;
    const profile = user && user.profile ? user.profile : null;
    const hobby =
      profile && profile.arrHobbies
        ? profile.arrHobbies.map((hobby) => (
            <span
              key={hobby}
      ...
      <Fragment>
        ...
        <div className='columns'>
          <div className='column'>
            ...
            <div className='view'>
              <p className='is-capitalized'>
                {profile && profile.pob ? profile.pob : '-'}
              </p>
            </div>
          </div>
          <div className='column'>
        ...
        <div className='columns'>
          <div className='column'>
            ...
            <div className='view'>
              <p className='is-capitalized'>
                {profile && profile.religion ? profile.religion : '-'}
              </p>
            </div>
          </div>
          {profile &&
            profile.religionDetail &&
        ...
        <div className='columns'>
          ...
          <div className='column'>
            ...
            <div className='view'>
              <p className='is-capitalized'>
                {profile && profile.maritalStatus ? profile.maritalStatus : '-'}
              </p>
            </div>
          </div>
        </div>
